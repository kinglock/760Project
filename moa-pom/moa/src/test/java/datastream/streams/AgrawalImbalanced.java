...
public class AgrawalImbalanced extends AgrawalGenerator {
        ...
        while (!desiredClassFound) {
            ...
            if (!this.balanceClassesOption.isSet()) {
                ...
                if ((this.nextClassShouldBeZero && (group == 0))
                    ...
                    if (group != 1 || (instanceRandom.nextDouble() < (weight / (1 - weight))) ) {
                    	desiredClassFound = true;
                    } else {
    ...
    public void restart() {
        ...
        this.weight = imbalanceWeightOption.getValue();        
        this.balanceClassesOption.setValue(true);       
    }
